...
TYPE_PROPERTY = "Tipo de Fonte"
CONTEXT_PROPERTY = "fonte_contexto"
CONTEXT_SCORE_PROPERTY = "fonte_contexto_score"
CONTEXT_TERMS_PROPERTY = "fonte_contexto_termos"
AUDIO_PROPERTY = "fonte_audio"
AUDIO_SCORE_PROPERTY = "fonte_audio_score"
AUDIO_TERMS_PROPERTY = "fonte_audio_termos"
...
def main() -> None:
    ...
    for feature in features:
        ...
        if context_result.label and audio_result.label:
            label = f"{context_result.label}_{audio_result.label}"
        elif audio_result.label:
            label = audio_result.label
        elif context_result.label:
            label = context_result.label
        else:
            label = "indefinido"
        ...
        props[AUDIO_PROPERTY] = audio_result.label or ""
        props[AUDIO_SCORE_PROPERTY] = audio_result.score
        props[AUDIO_TERMS_PROPERTY] = list(audio_result.matched_terms)
    ...
    save_geojson(GEOJSON_PATH, data)

    print(
        f"Processadas {len(features)} denúncias. "
        f"Resultados salvos em '{GEOJSON_PATH.name}'."
    )
